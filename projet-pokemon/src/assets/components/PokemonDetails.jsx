...
//       <p className="text-center mt-2 mb-4">ID : #{pokemon.id.toString().padStart(3, "0")}</p>
...
//             <li key={stat.stat.name} className="flex justify-between border-b py-1 capitalize">
...
//           <img src={pokemon.sprites.front_default} alt="Front" className="w-20 h-20" />
//           <img src={pokemon.sprites.back_default} alt="Back" className="w-20 h-20" />
//           <img src={pokemon.sprites.front_shiny} alt="Shiny Front" className="w-20 h-20" />
//           <img src={pokemon.sprites.back_shiny} alt="Shiny Back" className="w-20 h-20" />
//         </div>
//       </div>
//     </div>
//   );
